...
const kStripeProdSecretKey =
  "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";
const kStripeTestSecretKey =
  "sk_test_51Nc9QXKcbbpmiKV0hRWrObcL5DKDpUJPgg6NdmPeIDkw0G8Daq6DhKw59XUJ6nBzwQygbIxc7PVYZoyiDwSGkqvH00J7TmhU7l";
    ...
    await firestore
      ...
      .then(async (querySnapshot) => {
        for (var doc of querySnapshot.docs) {
          console.log(`Deleting document ${doc.id} from collection store`);
          await doc.ref.delete();
        }
      });
  });
