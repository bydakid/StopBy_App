...
class _EarningsWidgetState extends State<EarningsWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'earnings'});
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<StoreRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<StoreRecord> earningsStoreRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final earningsStoreRecord = earningsStoreRecordList.isNotEmpty
            ? earningsStoreRecordList.first
            : null;
                ...
                title: Row(
                  ...
                  children: [
                    InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent(
                            'EARNINGS_PAGE_Container_wog8af1z_ON_TAP');
                                        ...
                                        children: [
                                          ...
                                          Align(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '8yp2qhce' /* RM 100 - Transfer will be made... */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
