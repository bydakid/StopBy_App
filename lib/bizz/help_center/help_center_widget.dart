  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<StoreRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<StoreRecord> helpCenterStoreRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final helpCenterStoreRecord = helpCenterStoreRecordList.isNotEmpty
            ? helpCenterStoreRecordList.first
            : null;
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'HELP_CENTER_Container_6r2k53kt_ON_TAP');
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'HELP_CENTER_Container_5n1sp4j0_ON_TAP');
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'HELP_CENTER_Container_txpxz6i4_ON_TAP');
                ...
                title: Row(
                  ...
                  children: [
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  valueOrDefault<String>(
                                    helpCenterStoreRecord?.location?.name,
                                    'Name',
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                    ...
                    InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent(
                            'HELP_CENTER_Container_g52e6xkc_ON_TAP');
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'dmj08b1j' /* Here you can find answers to m... */,
                          ),
                                      ...
                                      children: [
                                        TextSpan(
                                          text: FFLocalizations.of(context)
                                              .getText(
                                            's1x1fmfe' /* Contact us directly at  */,
                                          ),
                                          style: TextStyle(),
                                        ),
                                        TextSpan(
                                          ...
                                          recognizer: TapGestureRecognizer()
                                            ..onTap = () async {
                                              logFirebaseEvent(
                                                  'HELP_CENTER_RichTextSpan_3owphdcb_ON_TAP');
                                              logFirebaseEvent(
