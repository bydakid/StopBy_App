...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF104229);
  late Color secondary = const Color(0xFF4AFF90);
  late Color tertiary = const Color(0xFFD9FFE8);
  late Color alternate = const Color(0xFFE0E3E7);
  late Color primaryText = const Color(0xFF000A03);
  late Color secondaryText = const Color(0xFF787878);
  late Color primaryBackground = const Color(0xFFF5F5F5);
  late Color secondaryBackground = const Color(0xFFD7D5D3);
  late Color accent1 = const Color(0xFF19955E);
  late Color accent2 = const Color(0xFF74A1DD);
  late Color accent3 = const Color(0xFFE7F1FF);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFFC5C5C5);
